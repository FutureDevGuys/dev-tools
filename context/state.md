...
- Publish and install dev-auth v0.3.7 with order-independent systemd socket activation, receipt-bound service-asset upgrades, and bounded broker-readiness retry; the contained v0.3.6 strong installation remains inactive and native Git/gh remain selected until the corrected setup passes.
