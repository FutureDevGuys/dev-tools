...
- Publish the prepared Update All 0.1.6 and sync-configs 0.1.12 artifacts with manifest generations 7 and 13 after the generic dev-auth/1Password release-key projection is available; do not export the release key through an ad hoc file or ambient environment workaround.
