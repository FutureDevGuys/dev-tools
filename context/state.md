...
- Implement the focused `dev-tools-update` foundation, migrate every public product to the common doctor/update/completion contract, and advance each product to full executable conformance without sibling-product runtime dependencies.
