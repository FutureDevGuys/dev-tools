...
- Publish dev-auth 0.3.6 with manifest generation 17, then use its broker-backed manifest-signing operation to publish the prepared Update All 0.1.6 and sync-configs 0.1.12 artifacts with generations 7 and 13; do not export the release key through a file or ambient environment.
