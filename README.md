...
On Linux x86-64, download `update-all-0.1.4-linux-x86_64` from the [`update-all/v0.1.4` release](https://github.com/FutureDevGuys/dev-tools/releases/tag/update-all%2Fv0.1.4), make it executable, and run:

```sh
./update-all-0.1.4-linux-x86_64 self install
